...
void Biblioteka::dodajPrace() {
    ...
    nowaPraca.Praca::idPraca = Biblioteka::getLastId(listaPrac) + 1;

    std::cout << "Dodano nowa instancje praca" << std::endl;
    std::cout << "ID tej pracy: " << nowaPraca.Praca::idPraca << std::endl;
    ...
    listaPrac.push_back(std::make_pair(nowaPraca.Praca::idPraca, nowaPraca));
